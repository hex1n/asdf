...
description: >
  ...
  Do not use for pure planning, architecture/design discussion, feasibility research, or non-Java implementation unless the task includes writing or reviewing Java stack code; for live JVM incidents use the /fixloop diagnose-fix loop, and for pure what-is-true system investigation use deep-research.
---

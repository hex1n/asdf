...
2. Choose the scenario from [REFERENCE.md](REFERENCE.md#research-scenario-gate): Codebase Investigation, External Investigation, or Mixed Investigation. Use it to set authority, orientation, and closure before gathering evidence.

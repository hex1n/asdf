...
| `scrutineer` | Contract-based review; counterexample search and disconfirmation of candidate findings; consequence-based severity separate from evidence strength; findings and remedies validated separately; revision-bound evidence. |

...
|---|---|---|
| P0 | Compile/test reaches project source and passes | High-confidence compile or behavior claim |
| P1 | Focused harness, targeted test, or reproduced local check passes | Local behavior claim for the checked path |
...
- Field injection is backlog signal in legacy Spring projects unless it blocks construction, tests, lifecycle safety, or the touched change.

...
| [`project-docs-layer`](skills/project-docs-layer/) | project docs | Audit or minimally repair a repo's operating docs via the four questions (Start/Verify/Direction/Danger); verified facts only, work discipline stays in the machine. |
